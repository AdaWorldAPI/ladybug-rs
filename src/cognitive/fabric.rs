...
impl CognitiveFabric {
    ...
    fn update_triangles_from_layers(&mut self, snapshot: &ConsciousnessSnapshot) {
        ...
        self.triangles
            .processing
            .nudge_toward(&proc_target.processing, 0.1);
        self.triangles
            .content
            .nudge_toward(&cont_target.content, 0.1);
        self.triangles
            .gestalt
    ...
    fn update_active_resonances(&mut self, input: &Fingerprint, threshold: f32) {
        ...
        self.active_resonances
            .retain(|(_, score)| *score > threshold * 0.5);
        ...
        if node_resonance > threshold && (node_resonance - tri_resonance).abs() > 0.1 {
            ...
            self.active_resonances
                .push((self.node.vsa_core.clone(), node_resonance));
        }
