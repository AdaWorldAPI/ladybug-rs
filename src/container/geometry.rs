//! Container geometry — how to interpret containers 1..N of a CogRecord.

/// How to interpret the content containers of a CogRecord.
///
/// Stored in metadata word 1 (bits 16-23).
